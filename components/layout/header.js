      ...
      <Row gutter={[24, 0]}>
        <Col span={24} md={6}>
          ...
          <div className="ant-page-header-heading">
            ...
            >
              {subName.split("/")[subName.split("/").length - 1].includes("-")
                ? `${subName
                    .split("/")
                    [subName.split("/").length - 1].replace("-", " ")}`
        ...
        <Col span={24} md={18} className="header-control">
          ...
          <Button onClick={openNotification}>{bell}</Button>
              ...
              <div className="sidebar-color">
                ...
                <div className="theme-color mb-2">
                  <ButtonContainer>
                    <Button
                      type="primary"
                      onClick={() => handleSidenavColor("#1dd3d5")}
                    >
                      1
                    </Button>
                    <Button
