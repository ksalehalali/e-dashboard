        ...
        <Menu.SubMenu key="category-sub" title="Category">
          ...
          <Menu.Item key="4">
            <Link href="/model-product">
              <a className={page === "model-product" ? "active" : ""}>
                <span
                  className="icon"
                  style={{
                    background: page === "model-product" ? color : "",
                  }}
                >
                  {modelProduct}
                </span>
        ...
        <Menu.SubMenu key="product-sub" title="Product">
          <Menu.Item key="product-sub-1">
            <Link href="/product-management/product/">
              <a
                className={
                  page === "product-management/product" ? "active" : ""
                }
              >
                <span
                  className="icon"
                  style={{
                    background:
                      page === "product-management/product" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
          ...
          <Menu.Item key="product-sub-3">
            <Link href="/product-management/product/colors">
              <a
                className={
                  page === "product-management/product/colors" ? "active" : ""
                }
              >
                <span
                  className="icon"
                  style={{
                    background:
                      page === "product-management/product/colors" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
          ...
          <Menu.Item key="product-sub-4">
            <Link href="/product-management/product/sizes">
              <a
                className={
                  page === "product-management/product/sizes" ? "active" : ""
                }
              >
                <span
                  className="icon"
                  style={{
                    background:
                      page === "product-management/product/sizes" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
        ...
        <Menu.SubMenu key="orders-sub" title="Orders">
          <Menu.Item key="orders-sub-5">
            <Link href="/order/all-order">
              <a className={page === "order/all-order" ? "active" : ""}>
                <span
                  className="icon"
                  style={{
                    background: page === "order/all-order" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
          ...
          <Menu.Item key="orders-sub-1">
            <Link href="/order/pending-orders">
              <a className={page === "order/pending-orders" ? "active" : ""}>
                <span
                  className="icon"
                  style={{
                    background: page === "order/pending-orders" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
          ...
          <Menu.Item key="orders-sub-2">
            <Link href="/order/processing-orders">
              <a className={page === "order/processing-orders" ? "active" : ""}>
                <span
                  className="icon"
                  style={{
                    background: page === "order/processing-orders" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
          ...
          <Menu.Item key="orders-sub-3">
            <Link href="/order/delivering-orders">
              <a className={page === "order/delivering-orders" ? "active" : ""}>
                <span
                  className="icon"
                  style={{
                    background: page === "order/delivering-orders" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
          ...
          <Menu.Item key="orders-sub-4">
            <Link href="/order/success-orders">
              <a className={page === "order/success-orders" ? "active" : ""}>
                <span
                  className="icon"
                  style={{
                    background: page === "order/success-orders" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
        ...
        <Menu.SubMenu key="deleted-sub" title="Deleted Orders">
          <Menu.Item key="orders-sub-1">
            <Link href="/order/waitting-remove-order">
              <a
                className={
                  page === "order/waitting-remove-order" ? "active" : ""
                }
              >
                <span
                  className="icon"
                  style={{
                    background:
                      page === "order/waitting-remove-order" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
          ...
          <Menu.Item key="orders-sub-2">
            <Link href="/order/removed-order">
              <a className={page === "order/removed-order" ? "active" : ""}>
                <span
                  className="icon"
                  style={{
                    background: page === "order/removed-order" ? color : "",
                  }}
                >
                  <TagsOutlined />
                </span>
